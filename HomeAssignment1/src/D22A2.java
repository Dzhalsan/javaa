...
//        System.out.println(Arrays.toString(test2(task5)));
...
//
//        Arrays.sort(arr); // Arrays sort ASC
//
...
//            if (arr[i-1] != arr[i]){
//                temp[counter++] = arr[i-1]; // assign unique values
//            }
//        }
//
//        if (temp[counter] != arr[arr.length-1]){ // check is the last element duplicate
//            temp[counter] = arr[arr.length-1];
//        }
//
//        return Arrays.copyOf(temp, counter); // return only unique elements
//    }
...
//
//        for (int num : array) {
//            boolean isDuplicate = false; // for checking is duplicate logic
//
//            for (int j = 0; j < counter; j++) {
//
//                if (num == temp[j]) { // check is duplicate
//                    isDuplicate = true;
//                    break;
//                }
//            }
//
//            if (!isDuplicate) {
//                temp[counter++] = num; // assign unique numbers
//            }
//        }
//
//        return Arrays.copyOf(temp, counter); // return only unique elements
